...
const Blog = () => {
    return (
        <div className='bg-[#030D1D]'>
            ...
            <div className="divider h-1 md:w-96 w-36 mx-auto mb-0 mt-[-11px]  bg-[#FFA07A]"></div>
            ...
            <div className='flex justify-center  mt-[100px] '>
                ...
                <div className='mx-5'>
                    ...
                    <div className="divider h-[2px] block mx-auto md:w-[196px] w-[130px] mt-[-2px] bg-[#FFA07A]"></div>
                </div>
